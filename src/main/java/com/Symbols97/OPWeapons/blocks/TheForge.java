...
public class theforge extends BlockContainer {

	public theforge(Material p_i45394_1_) {
		super(p_i45394_1_);
		this.setHardness(2.0F);
		this.setHarvestLevel("hand", 0);
		this.setStepSound(soundTypeMetal);
		this.setBlockBounds(0F, 0F, 0F, 1F, 1.9F, 1F);
	}
   ...
   {
    player.openGui(OPWeapons.instance, OPWeapons.GUITheForge, var1, var2, var3, var4);
    return true;
   }
   else
   {
