...
public class RepairStationContainerV2 extends Container {
	...
	public RepairStationContainerV2(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != OPWeapons.repairstationV2) {
			return false;
		}else{
