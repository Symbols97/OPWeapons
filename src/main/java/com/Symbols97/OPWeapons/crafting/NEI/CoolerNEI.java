...
public class CoolerNEI extends TemplateRecipeHandler
{
    ...
    public void loadTransferRects() {
    	transferRects.add(new RecipeTransferRect(new Rectangle(74, 38, 18, 18), "fuel"));
        transferRects.add(new RecipeTransferRect(new Rectangle(74, 10, 24, 18), "smelting"));
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals("smelting") && getClass() == CoolerNEI.class) {//don't want subclasses getting a hold of this
            Map<ItemStack, ItemStack> recipes = (Map<ItemStack, ItemStack>) CoolerRecipes.smelting().getSmeltingList();
    ...
    public void loadUsageRecipes(String inputId, Object... ingredients) {
        if (inputId.equals("fuel") && getClass() == CoolerNEI.class)//don't want subclasses getting a hold of this
