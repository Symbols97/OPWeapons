...
import com.Symbols97.OPWeapons.crafting.OPCraftingStation.opcraftingstationShapedRecipes;
import com.Symbols97.OPWeapons.crafting.OPCraftingStation.opcraftingstationcraftingmanager;
...
public class OPCraftingStationNEI extends TemplateRecipeHandler
{
    public class CachedShapedRecipe extends CachedRecipe
    {
        ...
        public CachedShapedRecipe(opcraftingstationShapedRecipes irecipe) {
    ...
    public Class<? extends GuiContainer> getGuiClass() {
        return GUIOPCraftingStation.class;
    }

    @Override
    public String getRecipeName() {
        return "OP Crafting Station";
    }

    @Override
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals("crafting") && getClass() == OPCraftingStationNEI.class) {
            for (IRecipe irecipe : (List<IRecipe>) opcraftingstationcraftingmanager.getInstance().getRecipeList()) {
                CachedShapedRecipe recipe = null;
                if (irecipe instanceof opcraftingstationShapedRecipes)
                    recipe = new CachedShapedRecipe((opcraftingstationShapedRecipes) irecipe);
    ...
    public String getGuiTexture() {
        return "opweapons:textures/gui/NEI_GUI/opcraftingstationgui.png";
    }
