...
public class DemonFurnaceNEI extends TemplateRecipeHandler
{
    public class SmeltingPair extends CachedRecipe
    {
        public SmeltingPair(ItemStack ingred, ItemStack result) {
            ...
            this.result = new PositionedStack(result, 111, 25);
        }
    ...
    public Class<? extends GuiContainer> getGuiClass() {
        return GUIDemonFurnace.class;
    }

    @Override
    public String getRecipeName() {
        return "Demon Furnace";
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals("smelting") && getClass() == DemonFurnaceNEI.class) {//don't want subclasses getting a hold of this
            Map<ItemStack, ItemStack> recipes = (Map<ItemStack, ItemStack>) DemonFurnaceRecipes.smelting().getSmeltingList();
    ...
    public void loadUsageRecipes(String inputId, Object... ingredients) {
        if (inputId.equals("fuel") && getClass() == DemonFurnaceNEI.class)//don't want subclasses getting a hold of this
    ...
    public String getGuiTexture() {
        return "opweapons:textures/gui/NEI_GUI/DemonFurnaceGUI.png";
    }

    public void drawBackground(int recipe) {
    	GL11.glColor4f(1, 1, 1, 1);
    	Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(getGuiTexture()));
    	drawTexturedModalRect(-5, -16, 0, -5, 176, 81);
    ...
    public void drawExtras(int recipe) {
        drawProgressBar(51, 25, 176, 0, 14, 14, 48, 7); // flame
        drawProgressBar(74, 23, 176, 14, 24, 16, 48, 0); //arrow
    }
    ...
    private static void findFuels() {
        ...
        for (ItemStack item : ItemList.items) {
            ...
            int burnTime = TileEntityDemonFurnace.getItemBurnTime(item);
            if (burnTime > 0)
