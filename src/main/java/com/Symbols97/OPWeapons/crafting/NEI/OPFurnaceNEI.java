...
public class OPFurnaceNEI extends TemplateRecipeHandler
{
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals("smelting") && getClass() == OPFurnaceNEI.class) {//don't want subclasses getting a hold of this
            Map<ItemStack, ItemStack> recipes = (Map<ItemStack, ItemStack>) OPFurnaceRecipes.smelting().getSmeltingList();
    ...
    public void loadUsageRecipes(String inputId, Object... ingredients) {
        if (inputId.equals("fuel") && getClass() == OPFurnaceNEI.class)//don't want subclasses getting a hold of this
    ...
    public String getGuiTexture() {
        return "opweapons:textures/gui/NEI_GUI/OPFurnaceGUI.png";
    }
    ...
    private static void findFuels() {
        ...
        for (ItemStack item : ItemList.items) {
            ...
            int burnTime = TileEntityOPFurnace.getItemBurnTime(item);
            if (burnTime > 0)
