...
public class opcraftingstationShapedRecipes implements IRecipe
{
    ...
    public opcraftingstationShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public opcraftingstationShapedRecipes func_92100_c()
    {
