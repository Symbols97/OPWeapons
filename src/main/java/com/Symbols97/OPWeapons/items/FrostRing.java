...
public class FrostRing extends Item {
	...
	public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer entity) {
		...
		if (entity instanceof EntityPlayerMP) {
            ...
            if (!management.isinFZ) {
            
            player.mcServer.getConfigurationManager().transferPlayerToDimension(player, DimensionRegistry.FZdimensionId, new FrostZoneTeleporter(worldserver));
            player.addChatMessage(new ChatComponentText(String.format("§bYou have been teleported to the Frost Zone")));
            
           
          
           
            } else if (management.isinFZ){
