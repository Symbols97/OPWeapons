...
public class OPGenLayerBiome extends GenLayer
{
    ...
    public OPGenLayerBiome(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_)
    {
        super(p_i2122_1_);
        ...
        if (p_i2122_4_ == WorldType.DEFAULT_1_1)
        {
            ...
            desertBiomes.add(new BiomeEntry(BiomeRegistry.biomeDeadZone, 10));
            desertBiomes.add(new BiomeEntry(BiomeRegistry.biomeFrostZone, 10));
        }
        else
        {
