package com.Symbols97.OPWeapons.screen.opfurnace;
...
public class OPFurnaceScreen extends AbstractContainerScreen<OPFurnaceMenu> {

	protected Component playerInventoryTitle;

	private static ResourceLocation TEXTURE = new ResourceLocation("opweapons:textures/gui/opfurnacegui.png");

	public OPFurnaceScreen(OPFurnaceMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
	...
	protected void init() {
	     ...
	     int y = (height - imageHeight) / 2;
	        ...
	        this.addRenderableWidget(new ExtendedButton(x + 155,y + 5,16, 16, Component.literal("?"), (button) -> {
	            Minecraft.getInstance().setScreen(new FuelScreen(Component.literal(""), 1));
	        }));
	...
	protected void renderLabels(PoseStack p_97808_, int p_97809_, int p_97810_) {
		this.font.draw(p_97808_, this.title, (float) this.titleLabelX + 50, (float) this.titleLabelY, 4210752);
		...
		String percentdisplay = String.format("§0Fuel: %d" + "%%", percent);
