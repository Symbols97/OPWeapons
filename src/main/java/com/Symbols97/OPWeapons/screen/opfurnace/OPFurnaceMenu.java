...
public class OPFurnaceMenu extends AbstractContainerMenu {
    ...
    public OPFurnaceBlockEntity blockEntity;
    private Level level;
    private final ContainerData data;

    public OPFurnaceMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
    }

    
    public OPFurnaceMenu(int pContainerId, Inventory inv, BlockEntity entity , ContainerData data) {
        super(MenuTypes.opfurnace_menu.get(), pContainerId);
        checkContainerSize(inv, 3);
        blockEntity = (OPFurnaceBlockEntity) entity;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, OPWBlocks.op_furnace.get());
    }
