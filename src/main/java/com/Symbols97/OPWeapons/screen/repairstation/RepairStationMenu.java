...
public class RepairStationMenu extends AbstractContainerMenu {
    public RepairStationBlockEntity blockEntity;
    private Level level;
    ...
    public RepairStationMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        super(MenuTypes.rps_menu.get(), pContainerId);
        checkContainerSize(inv, 3);
        blockEntity = (RepairStationBlockEntity) entity;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, OPWBlocks.repair_station.get());
    }
