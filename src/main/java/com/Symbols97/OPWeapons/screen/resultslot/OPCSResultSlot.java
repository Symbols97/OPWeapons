...
public class OPCSResultSlot extends Slot {
	   private final CraftingContainer craftSlots;
	   private final Player player;
	   private int removeCount;

	   public OPCSResultSlot(Player p_40166_, CraftingContainer p_40167_, Container p_40168_, int p_40169_, int p_40170_, int p_40171_) {
	   ...
	   public void onTake(Player p_150638_, ItemStack p_150639_) {
	      ...
	      NonNullList<ItemStack> nonnulllist = p_150638_.level.getRecipeManager().getRemainingItemsFor(OPCSRecipe.Type.INSTANCE, this.craftSlots, p_150638_.level);
