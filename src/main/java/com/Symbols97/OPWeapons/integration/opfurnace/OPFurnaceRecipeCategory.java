package com.Symbols97.OPWeapons.integration.opfurnace;
...
public class OPFurnaceRecipeCategory implements IRecipeCategory<OPFurnaceRecipe> {

	public final static ResourceLocation UID = new ResourceLocation(OPWeapons.MOD_ID, "3op_furnace");
	public final static ResourceLocation TEXTURE = new ResourceLocation(OPWeapons.MOD_ID, "textures/gui/nei_gui/opfurnacegui.png");
	...
	public OPFurnaceRecipeCategory(IGuiHelper guiHelper) {
...
//	}
	...
	@Override
	public void draw(OPFurnaceRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack, double mouseX, double mouseY) {
	...
	protected IDrawableAnimated getArrow(OPFurnaceRecipe recipe) {
	    int cookTime = 20;
	    if (cookTime <= 0)
	...
	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, OPFurnaceRecipe recipe, IFocusGroup focuses) {
