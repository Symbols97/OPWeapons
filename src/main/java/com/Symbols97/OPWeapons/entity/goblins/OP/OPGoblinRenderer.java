...
public class OPGoblinRenderer extends GeoEntityRenderer<GoblinEntity>  {
    public OPGoblinRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new OPGoblinModel());
