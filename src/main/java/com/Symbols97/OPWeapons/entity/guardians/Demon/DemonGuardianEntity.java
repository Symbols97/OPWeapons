...
public class DemonGuardianEntity extends BaseGuardianEntity{

	public DemonGuardianEntity(EntityType<? extends Monster> p_21368_, Level p_21369_) {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(2, new DemonGuardianEntity.DemonGuadianTargetGoal<>(this, Player.class));
	}
	
	 static class DemonGuadianTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
	      public DemonGuadianTargetGoal(DemonGuardianEntity p_33832_, Class<T> p_33833_) {
