...
public class FZStaff extends Item {
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List textList, boolean useAdvancedItemTooltips)
	 {
		 textList.add(com.mojang.realmsclient.gui.ChatFormatting.BLUE + "Ignites the Frost Zone Portal");
		 textList.add(com.mojang.realmsclient.gui.ChatFormatting.BLUE + "Do Not Use With a Full Inventory");
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer player, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        else
        {
            if (p_77648_3_.isAirBlock(p_77648_4_, p_77648_5_, p_77648_6_))
            {
                ...
                p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_, OPWeapons.FrostZonePortal);
            }
