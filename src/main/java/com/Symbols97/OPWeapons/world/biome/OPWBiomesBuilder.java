...
public class OPWBiomesBuilder {
	...
	private static Biome deadzonebiome(Biome.Precipitation precipitation, Biome.BiomeCategory category,
		...
		return deadzonebiome(precipitation, category, temperature, downfall, 4159204, 329011, spawnBuilder,
				biomeBuilder, music);
	}
	...
	private static Biome deadzonebiome(Biome.Precipitation precipitation, Biome.BiomeCategory category,
		...
		return (new Biome.BiomeBuilder()).precipitation(precipitation).biomeCategory(category).temperature(temperature)
				.downfall(downfall)
	...
	private static Biome frostzonebiome(Biome.Precipitation precipitation, Biome.BiomeCategory category, float temperature,
			float downfall, MobSpawnSettings.Builder spawnBuilder, BiomeGenerationSettings.Builder biomeBuilder,
			@Nullable Music music) {
		
		return frostzonebiome(precipitation, category, temperature, downfall, 4159204, 329011, spawnBuilder, biomeBuilder,
				music);
	}
	...
	public static Biome dead_zone_builder() {
		...
		return deadzonebiome(Biome.Precipitation.NONE, Biome.BiomeCategory.PLAINS, 2.0F, 0.0F, dz_spawns, biomeBuilder, NORMAL_MUSIC);
	}
	...
	public static Biome frost_zone_builder() {
		...
		return frostzonebiome(Biome.Precipitation.RAIN, Biome.BiomeCategory.ICY, -0.7F, 5.0F, spawnBuilder, biomeBuilder, NORMAL_MUSIC);
	}
