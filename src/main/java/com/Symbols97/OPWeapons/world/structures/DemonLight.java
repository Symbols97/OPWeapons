package com.Symbols97.OPWeapons.world.structures;
...
public class DemonLight extends StructureFeature<JigsawConfiguration> {
    ...
    public static final Codec<JigsawConfiguration> CODEC = RecordCodecBuilder.create((codec) -> {
        return codec.group(
                ...
                Codec.intRange(0, 600).fieldOf("size").forGetter(JigsawConfiguration::maxDepth)
        ).apply(codec, JigsawConfiguration::new);
    });

    public DemonLight() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, DemonLight::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!DemonLight.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            //OPWeapons.LOGGER.log(Level.DEBUG, "Sky Fan at {}", blockpos);
        }
